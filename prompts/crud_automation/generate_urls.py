...
def generate_urls_code(user_request: str, component: str):
    """
    ...
    system_instruction=f"""
        ...
        You have already defined models.py, serializers.py, views.py,
        now it's time include the link the viewsets in urls.py
...
if __name__=='__main__':
    ...
    logger.info("--- GENERATING DJANGO URLS.PY CODE ---")
    
    generated_code = generate_urls_code(
        user_request=urls_request,
        component="urls",
    )   
    ...
    if generated_code:
        ...
        current_script_dir,'../../ecommerce_project/ecommerce_project/urls.py'))
